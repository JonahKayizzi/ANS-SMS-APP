...
class SeverityController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('view'),
				'users'=>array('@'), 'expression' => array('Severity','checkIfUserIsCurrentRecordViewer'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Severity']))
		{
			...
			$model->attributes=$_POST['Severity'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Severity');
	...
	{
		$model=new Severity('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Severity']))
			$model->attributes=$_GET['Severity'];
	...
	{
		$model=Severity::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Severity $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='severity-form')
		{
