...
class EvidencesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('view'),
				'users'=>array('@'), 'expression' => array('Evidences','checkIfUserIsCurrentRecordViewer'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('Evidences');
	...
	{
		$model=Evidences::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Evidences $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='evidences-form')
		{
