      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Safety Logs Cause</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Assurance</li>
			<li class="active">Safety Logs Cause</li>
          </ol>
        </section>
		...
		<div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
				<?php $category = @SafetyLogsCategories::model()->findByPk($id); ?>
				...
				if($chart_type == 1){
					if($search_option == 'All'){
						$title1 = 'Safety Logs Count, '.$category->name.$title;
					}else{
						$title1 = 'Safety Logs Count, '.$category->name.$title.' '.$search_option_value.' : '.$search_value;
					}
				...
				if($chart_type == 2){
					if($search_option == 'All'){
						$title2 = 'Safety Logs Count, '.$category->name.$title;
					}else{
						$title2 = 'Safety Logs Count, '.$category->name.$title.' '.$search_option_value.' : '.$search_value;
					}
					$this->Widget('ext.highcharts.HighchartsWidget', array(
						'scripts' => array(
							'modules/exporting',
				...
				if($chart_type == 3){
					if($search_option == 'All'){
						$title3 = 'Safety Logs Count, '.$category->name.$title;
					}else{
						$title3 = 'Safety Logs Count, '.$category->name.$title.' '.$search_option_value.' : '.$search_value;
					}
					$this->Widget('ext.highcharts.HighchartsWidget', array(
						'scripts' => array(
							'modules/exporting',
