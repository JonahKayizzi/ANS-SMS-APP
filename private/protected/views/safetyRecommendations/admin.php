      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">Safety Requirements</li>
          </ol>
        </section>
        ...
        <section class="content">
			<div class="row">
					<div class="col-xs-12">
						...
						<?php echo CHtml::link('<i class="fa fa-pie-chart"></i> By Department', array('incidents/riskAnalyseDepartment'), array('class'=>'btn btn-app', 'style'=>'background-color: #3C8DBC; color: #fff;')); ?>
						
						<?php echo CHtml::link('<i class="fa fa-pie-chart"></i> By Division', array('incidents/riskAnalyseDivision'), array('class'=>'btn btn-app', 'style'=>'background-color: #3C8DBC; color: #fff;')); ?>
					</div>
				</div>
          <div class="row">
            <div class="col-xs-9">
              ...
              <div class="box">
				...
				<?php $this->widget('zii.widgets.grid.CGridView', array(
					'id'=>'safety-recommendations-grid',
