							  ...
							  <div class="row">
								<div class="col-md-12">
									<table class="table table-striped">
										<?php 
											$dates = @SafetyRequirementsReviewDates::model()->findAll("safety_requirement_id = '{$model->id}'");
									...
									<table class="table table-striped">
										<tr valign="top">
											<td width="100%">
												<?php echo $form->hiddenField($ReviewDate,'safety_requirement_id',array('value'=>$model->id)); ?>
											</td>
										</tr>
										<tr valign="top">
											<td width="100%">
