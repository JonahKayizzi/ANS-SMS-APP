      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Aircraft Incident Investigation Trend Analysis By Root Cause</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Assurance</li>
			<li class="active">Aircraft Incident Investigation Trend Analysis By Root Cause</li>
          </ol>
        </section>
						...
						foreach($root_causes as $root_cause){
							...
							while(strtotime($day) != strtotime($end)){
								...
								if($period_type == 1){
									...
									$items_count = @AircraftIncidentInvestigations::model()->getItemCount_7($day, $day, $root_cause->id);
									...
									$items_count = @AircraftIncidentInvestigations::model()->getItemCount_7($date_1, $date_2, $root_cause->id);
							...
							$pie_chart_rows[0] = "{$root_cause->name} ({$pie_chart_values})";
							...
							<td>
								...
								if($chart_type == 1){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Aircraft Incident Investigation Trend Analysis By Root Cause,{$title}",
											),
											'xAxis' => array(
							...
							<td>
								...
								if($chart_type == 3){
									$this->Widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array('text'=>"Aircraft Incident Investigation Trend Analysis By Root Cause,{$title}"),
