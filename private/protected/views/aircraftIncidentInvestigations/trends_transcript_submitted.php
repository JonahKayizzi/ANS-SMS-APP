      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Aircraft Incident Investigation Trend Analysis By Transcript Submission</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Assurance</li>
			<li class="active">Aircraft Incident Investigation Trend Analysis By Transcript Submission</li>
          </ol>
        </section>
					...
					<?php
						...
						while(strtotime($day) != strtotime($end)){
							...
							if($period_type == 1){
								...
								$submitted_count = @AircraftIncidentInvestigations::model()->getItemCount_4($day, $day, 'YES');
								$notsubmitted_count = @AircraftIncidentInvestigations::model()->getItemCount_4($day, $day, 'NO');
								...
								$submitted_count = @AircraftIncidentInvestigations::model()->getItemCount_4($date_1, $date_2, 'YES');
								$notsubmitted_count = @AircraftIncidentInvestigations::model()->getItemCount_4($date_1, $date_2, 'NO');
						...
						<tr>
							...
							if($chart_type == 1){
								$this->Widget('ext.highcharts.HighchartsWidget', array(
								   ...
								   'options'=>array(
									  'title' => array('text' => "Aircraft Incident Investigation Trend Analysis By Transcript Submission, {$title}"),
									  'xAxis' => array(
							...
							?>
								...
								if($chart_type == 2){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Aircraft Incident Investigation Trend Analysis By Transcript Submission,{$title}",
											),
											'xAxis' => array(
												'categories' => $dataArray_XAXIS,
											),
