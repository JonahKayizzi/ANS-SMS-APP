      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Aircraft Incident Investigation Trend Analysis By Preliminary Report Submission</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Assurance</li>
			<li class="active">Aircraft Incident Investigation Trend Analysis By Preliminary Report Submission</li>
          </ol>
        </section>
					...
					<?php
						...
						while(strtotime($day) != strtotime($end)){
							...
							if($period_type == 1){
								...
								$submitted_count = @AircraftIncidentInvestigations::model()->getItemCount_5($day, $day, 'YES');
								$notsubmitted_count = @AircraftIncidentInvestigations::model()->getItemCount_5($day, $day, 'NO');
								...
								$submitted_count = @AircraftIncidentInvestigations::model()->getItemCount_5($date_1, $date_2, 'YES');
								$notsubmitted_count = @AircraftIncidentInvestigations::model()->getItemCount_5($date_1, $date_2, 'NO');
						...
						$line_graph_SUBMITTED['name']='Submitted';
						$line_graph_SUBMITTED['data']=$dataArray_SUBMITTED;
						
						$line_graph_NOTSUBMITTED['name']='Not Submitted';
						...
						<tr>
							...
							if($chart_type == 1){
								$this->Widget('ext.highcharts.HighchartsWidget', array(
								   ...
								   'options'=>array(
									  'title' => array('text' => "Aircraft Incident Investigation Trend Analysis By Preliminary Report Submission, {$title}"),
									  'xAxis' => array(
							...
							?>
								...
								if($chart_type == 2){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Aircraft Incident Investigation Trend Analysis By Preliminary Report Submission,{$title}",
											),
											'xAxis' => array(
												'categories' => $dataArray_XAXIS,
											),
										...
										'options' => array(
										  ...
										  'series' => array(
											array(
											  ...
											  'name' => 'Percentage',
											  'data' => array(
												array("Submitted ({$pie_chart_SUBMITTED})", $pie_chart_SUBMITTED),
												array("Not Submitted ({$pie_chart_NOTSUBMITTED})", $pie_chart_NOTSUBMITTED),
											  ),
											),
										  ),
										)
