      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>Aircraft Incident Investigators #<?php echo $model->id; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class=""> Safety Assurance</li>
			<li class="active">Aircraft Incident Investigators #<?php echo $model->id; ?></li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table class="table table-stripped">
					...
					<tr>
						<td style="width: 25%">
							<b><?php echo $model->attributeLabels()['aircraft_incident_investigation_id']; ?></b>
						</td>
						<td><?php echo @$model->aircraftInvestigation->description; ?></td>
					</tr>
					<tr>
						<td style="width: 25%">
							<b><?php echo $model->attributeLabels()['investigator_id']; ?></b>
						</td>
						<td><?php echo @$model->investigator->name; ?></td>
					</tr>
					<tr>
						<td style="width: 25%">
