...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php /* echo $form->labelEx($model,'change_management_id'); */ ?>
		<?php echo $form->hiddenField($model,'change_management_id',array('value'=>$id)); ?>
		<?php echo $form->error($model,'change_management_id'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'item'); ?>
		<?php echo $form->textField($model,'item',array('class'=>'form-control')); ?>
	...
	<div class="form-group">
		...
		<?php echo $form->dropDownList($model,'unit', array('UGX'=>'UGX', 'USD'=>'USD'),array('class'=>'form-control')); ?>
