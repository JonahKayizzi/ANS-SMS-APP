							  ...
							  <div class="row">
								<div class="col-md-12">
									<table class="table table-striped">
										...
										<?php 
											$dates = @SafetyRequirementsNextReviewDates::model()->findAll("safety_requirement_id = '{$safety_requirement_id->id}'");
									...
									<table class="table table-striped">
										<tr valign="top">
											<td width="100%">
												...
												<?php echo $form->hiddenField($NextReviewDate,'safety_requirement_id',array('value'=>@$safety_requirement_id->id)); ?>
											</td>
										</tr>
										<tr valign="top">
											<td width="100%">
