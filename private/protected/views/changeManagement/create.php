              ...
              <div class="box">
				...
				?>
					<div class="alert alert-info alert-dismissable">
						...
						You have been redirected to this page out of procedure. Before initiating a System &amp; Task Analysis form, you must first create a Change Management Form from here.
					  </div>
				<?php
					}
				?>
