      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Safety Logs Categories</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Assurance</li>
			<li class="active">Safety Logs Categories</li>
          </ol>
        </section>
			...
			<div class="col-xs-3">
				<div class="box box-default">
				  ...
				  <div class="box box-default">
					...
					<div class="box-body">
					  <ul>
						<li><?php echo CHtml::link('View Totals', array('/'.Yii::app()->getController()->getId().'/totals')); ?></li>
					  </ul>
					</div><!-- /.box-body -->
				  </div><!-- /.box -->
