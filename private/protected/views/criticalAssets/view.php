      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Critical Assets #<?php echo $model->id; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Assurance</li>
			<li class="active">Critical Assets #<?php echo $model->id; ?></li>
          </ol>
        </section>
            ...
            <div class="col-xs-9">
              ...
              <div class="box">
				...
				<table class="table table-stripped">
					...
					<tr>
						<td style="width: 25%">
							<b><?php echo $model->attributeLabels()['descripiton']; ?></b>
						</td>
						<td><?php echo $model->descripiton; ?></td>
					</tr>
					<tr>
						<td style="width: 25%">
							<b><?php echo $model->attributeLabels()['value']; ?></b>
						</td>
