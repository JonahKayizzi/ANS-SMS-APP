      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Risk Analysis By Operation Type</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management</li>
			<li class="active">Risk Analysis By Operation Type</li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php
						...
						$operation_types_collection = array();
						
						$title = "";
						
						//$end_date = date('Y-m-d', strtotime($end_date. " + 1 days"));
						$operation_types = @OperationTypes::model()->findAll("status = 1");
						...
						foreach($operation_types as $operation_type){
							...
							$dataArray_OPERATION_TYPES = array();
							$operation_types_holder = array();
							$pie_chart_values = 0;
							$pie_chart_rows = array();
							...
							while(strtotime($day) != strtotime($end)){
								...
								if($period_type == 1){
									...
									$items_count = @Incidents::model()->getItemCount_3($day, $day, $main_category, $operation_type->id);
									...
									$items_count = @Incidents::model()->getItemCount_3($date_1, $date_2, $main_category, $operation_type->id);
								...
								array_push($dataArray_OPERATION_TYPES, $items_count);
							...
							$operation_types_holder['type'] = 'column';
							$operation_types_holder['name'] = @$operation_type->name;
							$operation_types_holder['data'] = $dataArray_OPERATION_TYPES;
							array_push($operation_types_collection, $operation_types_holder);
							...
							unset($dataArray_OPERATION_TYPES);
							unset($operation_types_holder);
							...
							<td>
								...
								if($chart_type == 1){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Risk Analysis By Operation Type Chart,{$title}, {$main_category}(s)",
											),
											'xAxis' => array(
											...
											'series' => $operation_types_collection,
										)
									));									
								}
							...
							<td>
								...
								if($chart_type == 3){
									$this->Widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array('text'=>"Risk Analysis By Operation Type Chart,{$title}, {$main_category}(s)"),
