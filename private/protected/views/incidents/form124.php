<?php 
$form124_data = @SmsForm124Data::model()->find("incident_id={$model->id} and status = 1"); 
?>
<div class="row">
	<div class="col-lg-12">
	<style> .cls1 td{border: 1px #000 solid; padding: 2px;}</style>
		...
		<table class="table"  style="width: 100%;" class="cls1">
			<tr>
				<td colspan="3">
		...
		if(!@empty($form124_contributing_factors)){
			$k = 1;
			echo "<table class='table' width='100%' class='cls1' >";
		...
		<?php
			...
			echo "<p>No contributing factors available.</p>";
		}
		?>
		<br />
		...
		<?php
			...
			echo "<p>No corrective actions available.</p>";
		}
		?>
		<br />
		...
		<table class='table' width="100%" class="cls1">
			<tr>
				<td>
					<ul>
