...
switch(type) {
		...
		var $category = $("#Incidents_category");
		$category.empty();
              ...
              <div class="box">
				...
				?>
					<div style="width: 100%; padding: 5px; border: 1px #ccc solid; background-color: #eee; margin-bottom: 7px;">
						<b>Parent <?php echo $model->main_category; ?> No.: </b> <?php $incident = $_GET['incident']; $incident_info = @Incidents::model()->findByPk($incident); echo $incident; ?><br />
