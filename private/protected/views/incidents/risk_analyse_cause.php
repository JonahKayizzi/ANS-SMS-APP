      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Risk Analysis By Cause</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management</li>
			<li class="active">Risk Analysis By Cause</li>
          </ol>
        </section>
			...
			<?php $form=$this->beginWidget('CActiveForm', array(
				...
				<table class="table">
					<tr>
						...
						<td>
						<?php
							echo CHtml::dropDownList('incident_cause_main', '',IncidentCausesMain::model()->getOptionsAll(),array('class'=>'form-control', ));
						?>
						</td>
						<td>
              ...
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php
						...
						if($incident_cause_main == 0){
							$options = @IncidentCausesSub::model()->findAll("status = 1");
							$title_cause = "";
						}else{
							$options = @IncidentCausesSub::model()->findAll("status = 1 and main_id = {$incident_cause_main}");
							$title_cause = " (".@IncidentCausesMain::model()->findByPk($incident_cause_main)->name.")";
						}
						...
						foreach($options as $option){
							...
							while(strtotime($day) != strtotime($end)){
								...
								if($period_type == 1){
									...
									$items_count = @IncidentsCauses::model()->getItemCount_6($day, $day, $main_category, $option->id);
									...
									$items_count = @IncidentsCauses::model()->getItemCount_6($date_1, $date_2, $main_category, $option->id);
							...
							<td>
								...
								if($chart_type == 1){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Risk Analysis By Cause Chart{$title_cause},{$title}, {$main_category}(s)",
											),
											'xAxis' => array(
							...
							<td>
								...
								if($chart_type == 3){
									$this->Widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array('text'=>"Risk Analysis By Cause Chart{$title_cause},{$title}, {$main_category}(s)"),
