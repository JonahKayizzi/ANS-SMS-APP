							  ...
							  <div class="row">
								<div class="col-md-12">
									...
									<table class="table table-striped">
										<tr valign="top">
											<td width="100%">
												<?php echo $form->dropDownList($NextReviewDate,'safety_requirement_id',@SafetyRecommendations::model()->getOptionsForContent($content_type, $content_id),array('class'=>'form-control')); ?>
											</td>
										</tr>
										<tr valign="top">
											<td width="100%">
