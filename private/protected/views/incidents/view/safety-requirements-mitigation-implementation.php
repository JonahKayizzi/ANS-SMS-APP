					...
					<div class="col-md-12">
						<div class="box box-default collapsed-box">
							<div class="box-header with-border">
							  <h3 class="box-title">Mitigation Implementation</h3>
							  ...
							  <div class="row">
								<div class="col-md-12">
									<table class="table table-striped">
										...
										<?php 
											$actions = @Actions::model()->findAll("incident_id = '{$model->id}' and status = 1");
											
											if(!empty($actions)){
										?>
											<tr valign="top"  class="" style="" >
												<td><b>Safety Requirement</b></td>
												<td><b>Action</b></td>
										...
										?>
											<tr valign="top"  class="" >
												...
												<td><?php echo number_format((abs((strtotime($action->date_action_taken) - strtotime($model->date_reported))/(60*60*24)))); ?></td>
												<td><?php echo $action->accepted; ?></td>
												<td><?php echo $action->comment; ?></td>
												<td><?php echo $action->reported_by; ?></td>
												<td><?php echo CHtml::link($image_edit, array('actions/update', 'id'=>$action->id), array('onClick'=>"return popup(this, 'action')")); ?></td>
									...
									<table class="table table-striped">
										<tr valign="top">
											...
											<td >
												<?php
												echo CHtml::dropDownList('safety_recommendation_id', '',SafetyRecommendations::model()->getOptionsForImplementation(1, $model->id),array('class'=>'form-control', ));
											?>
											</td>
										</tr>
										<tr valign="top">
