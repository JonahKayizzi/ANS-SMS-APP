      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Risk Analysis By Division</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management</li>
			<li class="active">Risk Analysis By Division</li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php
						...
						$options = @UserDivisions::model()->findAll("status = 1");
						...
						foreach($options as $option){
							...
							while(strtotime($day) != strtotime($end)){
								...
								if($period_type == 1){
									...
									$items_count = @SafetyRecommendations::model()->getItemCountByDivision($day, $day, $option->id);
									...
									$items_count = @SafetyRecommendations::model()->getItemCountByDivision($date_1, $date_2, $option->id);
							...
							<td>
								...
								if($chart_type == 1){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Risk Analysis By Division Chart {$title}",
											),
											'xAxis' => array(
							...
							<td>
								...
								if($chart_type == 3){
									$this->Widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array('text'=>"Risk Analysis By Division Chart {$title}"),
