      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Risk Analysis By Hazard Source</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management</li>
			<li class="active">Risk Analysis By Hazard Source</li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php
						...
						$root_causes = @HazardSources::model()->findAll("status = 1");
						...
						foreach($root_causes as $root_cause){
							...
							while(strtotime($day) != strtotime($end)){
								...
								if($period_type == 1){
									...
									$items_count = @Incidents::model()->getItemCount_6($day, $day, $main_category, $root_cause->id);
									...
									$items_count = @Incidents::model()->getItemCount_6($date_1, $date_2, $main_category, $root_cause->id);
							...
							<td>
								...
								if($chart_type == 1){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Risk Analysis By Hazard Source Chart,{$title}, {$main_category}(s)",
											),
											'xAxis' => array(
							...
							<td>
								...
								if($chart_type == 3){
									$this->Widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array('text'=>"Risk Analysis By Hazard Source Chart,{$title}, {$main_category}(s)"),
