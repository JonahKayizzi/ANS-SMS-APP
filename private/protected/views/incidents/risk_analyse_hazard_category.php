      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Risk Analysis For Hazard Category</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management</li>
			<li class="active">Risk Analysis For Hazard Category</li>
          </ol>
        </section>
              ...
              <div class="box">
                ...
                <div class="box-body">
					...
					<?php
						...
						//note: WORKPLACE = OSHE, AIRCRAFT = AVIATION
						...
						while(strtotime($day) != strtotime($end)){
							...
							if($period_type == 1){
								...
								$workplace_count = @Incidents::model()->getItemCount_8_1($day, $day, 'OSHE');
								$aircraft_count = @Incidents::model()->getItemCount_8_1($day, $day, 'Aviation');
								...
								$workplace_count = @Incidents::model()->getItemCount_8_1($date_1, $date_2, 'OSHE');
								$aircraft_count = @Incidents::model()->getItemCount_8_1($date_1, $date_2, 'Aviation');
						...
						$line_graph_WORKPLACE['name']='OSHE';
						$line_graph_WORKPLACE['data']=$dataArray_WORKPLACE;
						
						$line_graph_AIRCRAFT['name']='Aviation';
						...
						<tr>
							...
							if($chart_type == 1){
								$this->Widget('ext.highcharts.HighchartsWidget', array(
								   ...
								   'options'=>array(
									  'title' => array('text' => "Risk Analysis For Hazard Category, {$title}"),
									  'xAxis' => array(
							...
							?>
								...
								if($chart_type == 2){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Risk Analysis For Hazard Category,{$title}",
											),
											'xAxis' => array(
												'categories' => $dataArray_XAXIS,
												'labels'=>array('rotation'=>45),
										...
										'options' => array(
										  ...
										  'series' => array(
											array(
											  ...
											  'name' => 'Percentage',
											  'data' => array(
												array("OSHE ({$pie_chart_WORKPLACE})", $pie_chart_WORKPLACE),
												array("Aviation ({$pie_chart_AIRCRAFT})", $pie_chart_AIRCRAFT),
											  ),
											),
										  ),
										)
