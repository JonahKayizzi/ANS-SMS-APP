      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Reccuring Risks</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management</li>
			<li class="active">Reccuring Risks</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
				...
				<?php
					$incidents = @Incidents::model()->findAll("reoccuring = 1 and date between '{$start_dt}' and '{$end_dt}'");
					if(!empty($incidents)){
						$k=1;
				?>
				...
				<?php
						...
						echo "<div style='width: 100%; text-align: center;'>There are no reoccuring incidents for date between '{$start_dt}' and '{$end_dt}'</div>";
					}
				?>
