      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Risk Analysis By Recurring</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management</li>
			<li class="active">Risk Analysis By Recurring</li>
          </ol>
        </section>
					...
					<?php
						...
						while(strtotime($day) != strtotime($end)){
							...
							if($period_type == 1){
								...
								$items_count = @MonitoringPerformance::model()->getItemCount_5($day, $day, $main_category);
								...
								$items_count = @MonitoringPerformance::model()->getItemCount_5($date_1, $date_2, $main_category);
							...
							array_push($dataArray_YAXIS, $items_count);
							...
							<?php 
								if($chart_type == 1){
									$this->widget('ext.highcharts.HighchartsWidget', array(
										...
										'options' => array(
											'title' => array(
												'text' => "Risk Analysis By Recurring,{$title}, {$main_category}(s)",
											),
											'xAxis' => array(
						...
						<tr>
							<td>
								...
								if($chart_type == 2){
									$this->Widget('ext.highcharts.HighchartsWidget', array(
									   'options'=>array(
										  'title' => array('text' => "Risk Analysis By Recurring,{$title}, {$main_category}(s)"),
										  'xAxis' => array(
												'categories' => $dataArray_XAXIS,
												'labels'=>array('rotation'=>45),
											),
										  'series' => array(
											 array('name' => 'Recurring', 'data' => $dataArray_YAXIS),
										  )
									   )
									));	
								}
