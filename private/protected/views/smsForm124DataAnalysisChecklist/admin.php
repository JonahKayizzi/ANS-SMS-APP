      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Data Analysis Checklists</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Risk Management </li>
			<li class="active">Data Analysis Checklists</li>
          </ol>
        </section>
            ...
            <div class="col-xs-9">
              ...
              <div class="box">
				...
				<?php $this->widget('zii.widgets.grid.CGridView', array(
					'id'=>'sms-form124-data-analysis-checklist-grid',
					...
					'columns'=>array(
						...
						/* 'photographos',
						'diagrams',
						'supervisor_statements',
						'witness_statements',
						'employment_history', */
						/*
						'employee_statement',
						'walk_around_checklist',
						'training_records',
						'police_reports',
						'other',
						'modified',
