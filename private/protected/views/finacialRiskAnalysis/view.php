      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Finacial Risk Analysis #<?php echo $model->id; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Assurance</li>
			<li class="active">Finacial Risk Analysis #<?php echo $model->id; ?></li>
          </ol>
        </section>
            ...
            <div class="col-xs-9">
              ...
              <div class="box">
				...
				<table class="table table-stripped">
					...
					<tr>
						<td style="width: 25%">
							<b><?php echo $model->attributeLabels()['hazzard_no']; ?></b>
						</td>
						<td><?php echo $model->hazzard_no; ?></td>
					</tr>
					<tr>
						<td style="width: 25%">
					...
					<tr>
						<td style="width: 25%">
							<b><?php echo $model->attributeLabels()['warranty']; ?></b>
						</td>
						<td><?php echo $model->warranty; ?></td>
					</tr>
					<tr>
						<td style="width: 25%">
					...
					<tr>
						<td style="width: 25%">
							<b><?php echo $model->attributeLabels()['date_modified']; ?></b>
						</td>
						<td><?php echo $model->date_modified; ?></td>
					</tr>
				</table>
