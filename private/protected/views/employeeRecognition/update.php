      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>EmployeeRecognition <?php echo $model->id; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Promotions</li>
			<li class="active">EmployeeRecognition <?php echo $model->id; ?></li>
          </ol>
        </section>
            ...
            <div class="col-xs-9">
              ...
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">EmployeeRecognition <?php echo $model->id; ?></h3>
