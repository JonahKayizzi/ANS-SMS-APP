      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li class="active">Additional Comments</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-9">
              ...
              <div class="box">
				...
				if(isset($_GET['del'])){
					if($_GET['del']==1){
						if(@SmsForm124Comments::model()->updateByPk($_GET['id'], array('status'=>0))){
				?>
				...
				<?php
				$items = @SmsForm124Comments::model()->findAll("incident_id = '{$incident}' and status = 1");
				$k=1;
				echo "<table class='table table-striped' >";
				foreach($items as $item){
					echo "<tr>";
					echo "<td style='' >{$k}</td><td  style=''>".$item->comment." </td><td  style=''>".$item->modified." </td><td  style=''>".CHtml::link('<img src="images/delete.png" alt="Delete" />', array('create', 'incident'=>$incident, 'del'=>1, 'id'=>$item->id), array('confirm'=>'Are you sure?')).' '."</td>";
					echo "</tr>";
					$k++;
				}
				echo "</table>";
