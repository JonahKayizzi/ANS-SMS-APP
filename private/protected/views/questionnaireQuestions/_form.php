...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'questionnaire-questions-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'question_no'); ?>
		<?php echo $form->textField($model,'question_no',array('size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'question_no'); ?>
	</div>
