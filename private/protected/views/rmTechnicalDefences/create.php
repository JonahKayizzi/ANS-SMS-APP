      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           <h1>
            ...
            <small>Risk Management Technical Defences</small>
          </h1>
          <ol class="breadcrumb">
            <li><?php echo CHtml::link('<i class="fa fa-dashboard"></i> Home', array('/site/dashboard/')); ?></li>
            <li class="">Safety Policy &amp; Objectives</li>
			<li class="active">Risk Management Technical Defences</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-9">
              ...
              <div class="box">
				...
				<?php
				$items = @RmTechnicalDefences::model()->findAll("risk_management_id = {$rm_id} and status = 1");
				if(!empty($items)){
					$k = 1;
				?>
