...
/**
 * This is the model class for table "existing_defenses".
 *
 * The followings are the available columns in table 'existing_defenses':
 * @property integer $id
 ...
 */
class ExistingDefenses extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, details, modified, status, incident_id, reported_by', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ExistingDefenses the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = ExistingDefenses::model()->findByPk($current_record_id);
