...
/**
 * This is the model class for table "rm_consequences".
 *
 * The followings are the available columns in table 'rm_consequences':
 * @property integer $id
 ...
 */
class RmConsequences extends CActiveRecord
{
	/**
	 ...
	 * @return RmConsequences the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = RmConsequences::model()->findByPk($current_record_id);
