...
/**
 * This is the model class for table "sms_form_124_contributing_factors".
 *
 * The followings are the available columns in table 'sms_form_124_contributing_factors':
 * @property integer $id
 ...
 */
class SmsForm124ContributingFactors extends CActiveRecord
{
	/**
	...
	{
		return 'sms_form_124_contributing_factors';
	}
	...
	public function rules()
	{
		...
		return array(
			array('details, reported_by, incident_id', 'required'),
			...
			array('id, details, modified, reported_by, status, incident_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SmsForm124ContributingFactors the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = SmsForm124ContributingFactors::model()->findByPk($current_record_id);
