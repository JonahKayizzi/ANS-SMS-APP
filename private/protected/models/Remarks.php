 ...
 *
 * The followings are the available columns in table 'remarks':
 * @property integer $id
 ...
 */
class Remarks extends CActiveRecord
{
	/**
	 ...
	 * @return Remarks the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = Remarks::model()->findByPk($current_record_id);
