 ...
 *
 * The followings are the available columns in table 'user_departments':
 * @property integer $id
 * @property string $name
 * @property string $description
 * @property integer $status
 */
class UserDepartments extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'users0' => array(self::HAS_MANY, 'Users', 'user_department_id'),
		);
	}
	...
	public static function getOptions(){
		$items = UserDepartments::model()->findAll();
		$data = array(null=>"Select Department");
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = UserDepartments::model()->findByPk($current_record_id);
