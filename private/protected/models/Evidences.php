 ...
 *
 * The followings are the available columns in table 'evidences':
 * @property integer $id
 ...
 */
class Evidences extends CActiveRecord
{
	/**
	 ...
	 * @return Evidences the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = Evidences::model()->findByPk($current_record_id);
