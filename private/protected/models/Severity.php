 ...
 *
 * The followings are the available columns in table 'severity':
 * @property integer $id
...
class Severity extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('severity, likelihood, reported_by', 'required'),
			...
			array('id, severity, severity_rationale, likelihood, likelihood_rationale, modified, status, incident_id, reported_by', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Severity the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = Severity::model()->findByPk($current_record_id);
