 ...
 *
 * The followings are the available columns in table 'operation_types':
 * @property integer $id
 * @property string $name
 * @property integer $status
 */
class OperationTypes extends CActiveRecord
{
	/**
	 ...
	 * @return OperationTypes the static model class
	 */
	...
	public static function getOptions(){
		$cats = @OperationTypes::model()->findAll("status=1");
		$data = array(null=>"Select Operation Type");
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = OperationTypes::model()->findByPk($current_record_id);
