...
/**
 * This is the model class for table "audit_plan_fields".
 *
 * The followings are the available columns in table 'audit_plan_fields':
 * @property integer $id
 ...
 */
class AuditPlanFields extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, audit_plan_id, description', 'required'),
			array('audit_plan_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>256),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, description, audit_plan_id, date', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return AuditPlanFields the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = AuditPlanFields::model()->findByPk($current_record_id);
