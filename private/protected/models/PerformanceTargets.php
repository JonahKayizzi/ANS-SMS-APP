...
/**
 * This is the model class for table "performance_targets".
 *
 * The followings are the available columns in table 'performance_targets':
 * @property integer $id
 ...
 */
class PerformanceTargets extends CActiveRecord
{
	/**
	 ...
	 * @return PerformanceTargets the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = PerformanceTargets::model()->findByPk($current_record_id);
