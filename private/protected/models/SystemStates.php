...
/**
 * This is the model class for table "system_states".
 *
 * The followings are the available columns in table 'system_states':
 * @property integer $id
 ...
 */
class SystemStates extends CActiveRecord
{
	/**
	 ...
	 * @return SystemStates the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = SystemStates::model()->findByPk($current_record_id);
