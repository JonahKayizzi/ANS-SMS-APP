...
/**
 * This is the model class for table "severities".
 *
 * The followings are the available columns in table 'severities':
 * @property integer $id
 * @property string $name
 * @property string $value
 */
class Severities extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'severityRationales' => array(self::HAS_MANY, 'SeverityRationales', 'severity_id'),
		);
	}
	 ...
	 * @return Severities the static model class
	 */
	...
	public static function getOptions(){
		$cats = Severities::model()->findAll();
		$data = array(null=>"Select Severity");
		foreach($cats as $model){
			$data[$model->id] = $model->name.' - '.$model->value;
		}
		return $data;
	}
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = Severities::model()->findByPk($current_record_id);
