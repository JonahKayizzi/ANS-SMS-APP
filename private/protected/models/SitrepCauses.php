...
/**
 * This is the model class for table "sitrep_causes".
 *
 * The followings are the available columns in table 'sitrep_causes':
 * @property integer $id
 * @property string $name
 * @property integer $status
 */
class SitrepCauses extends CActiveRecord
{
	/**
	 ...
	 * @return SitrepCauses the static model class
	 */
	...
	public static function getOptions(){
		$titles = SitrepCauses::model()->findAll();
		$data = array(null=>"Select SITREP Cause");
	...
	public function getCount($cause){
		$incidents = @Incidents::model()->findAll("sitrep_cause = {$cause}");
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = SitrepCauses::model()->findByPk($current_record_id);
