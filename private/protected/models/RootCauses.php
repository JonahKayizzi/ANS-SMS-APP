...
/**
 * This is the model class for table "root_causes".
 *
 * The followings are the available columns in table 'root_causes':
 * @property integer $id
 * @property string $name
 * @property integer $status
 */
class RootCauses extends CActiveRecord
{
	/**
	 ...
	 * @return RootCauses the static model class
	 */
	...
	public static function getOptions(){
		$cats = @RootCauses::model()->findAll("status=1");
		$data = array(null=>"Select Root Cause");
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = RootCauses::model()->findByPk($current_record_id);
