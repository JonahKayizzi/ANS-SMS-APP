...
/**
 * This is the model class for table "aircraft_types".
 *
 * The followings are the available columns in table 'aircraft_types':
 * @property integer $id
 * @property string $name
 * @property integer $status
 */
class AircraftTypes extends CActiveRecord
{
	/**
	 ...
	 * @return AircraftTypes the static model class
	 */
	...
	public static function getAircraftTypeOptions(){ 
		$types = @AircraftTypes::model()->findAll("status=1");
		$data = array(null=>"Select aircraft type");
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = AircraftTypes::model()->findByPk($current_record_id);
