...
/**
 * This is the model class for table "task_step_hazards".
 *
 * The followings are the available columns in table 'task_step_hazards':
 * @property integer $id
 ...
 */
class TaskStepHazards extends CActiveRecord
{
	/**
	 ...
	 * @return TaskStepHazards the static model class
	 */
	...
	public static function getOptions(){
		$opts = TaskStepHazards::model()->findAll();
		$data = array(null=>"Select Hazard");
		foreach($opts as $opt){
			$data[$opt->id] = $opt->details;
		}
		return $data;
	}
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = TaskStepHazards::model()->findByPk($current_record_id);
