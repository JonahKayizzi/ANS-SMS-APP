...
/**
 * This is the model class for table "task_step_comments".
 *
 * The followings are the available columns in table 'task_step_comments':
 * @property integer $id
 ...
 */
class TaskStepComments extends CActiveRecord
{
	/**
	 ...
	 * @return TaskStepComments the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = TaskStepComments::model()->findByPk($current_record_id);
