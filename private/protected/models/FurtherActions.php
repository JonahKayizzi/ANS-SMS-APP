...
/**
 * This is the model class for table "further_actions".
 *
 * The followings are the available columns in table 'further_actions':
 * @property integer $id
 ...
 */
class FurtherActions extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, details, modified, status, incident_id, reported_by, comment, accepted', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return FurtherActions the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = FurtherActions::model()->findByPk($current_record_id);
