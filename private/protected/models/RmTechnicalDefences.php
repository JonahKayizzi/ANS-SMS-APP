...
/**
 * This is the model class for table "rm_technical_defences".
 *
 * The followings are the available columns in table 'rm_technical_defences':
 * @property integer $id
 ...
 */
class RmTechnicalDefences extends CActiveRecord
{
	/**
	 ...
	 * @return RmTechnicalDefences the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = RmTechnicalDefences::model()->findByPk($current_record_id);
