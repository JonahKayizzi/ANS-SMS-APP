 ...
 *
 * The followings are the available columns in table 'causes':
 * @property integer $id
 ...
 */
class Causes extends CActiveRecord
{
	/**
	 ...
	 * @return Causes the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = Causes::model()->findByPk($current_record_id);
