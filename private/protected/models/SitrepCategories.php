...
/**
 * This is the model class for table "sitrep_categories".
 *
 * The followings are the available columns in table 'sitrep_categories':
 * @property integer $id
 * @property string $name
 * @property integer $status
 */
class SitrepCategories extends CActiveRecord
{
	/**
	 ...
	 * @return SitrepCategories the static model class
	 */
	...
	public static function getOptions(){
		$titles = SitrepCategories::model()->findAll();
		$data = array(null=>"Select SITREP Category");
	...
	public function getCount($category){
		$incidents = @Incidents::model()->findAll("sitrep_category = {$category}");
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = SitrepCategories::model()->findByPk($current_record_id);
