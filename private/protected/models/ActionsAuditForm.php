...
/**
 * This is the model class for table "actions_audit_form".
 *
 * The followings are the available columns in table 'actions_audit_form':
 * @property integer $id
 ...
 */
class ActionsAuditForm extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('status, audit_form_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, details, modified, deadline, date_action_taken, status, audit_form_id, reported_by, accepted, comment, notification', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('audit_form_id',$this->audit_form_id);
	 ...
	 * @return ActionsAuditForm the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = ActionsAuditForm::model()->findByPk($current_record_id);
