...
/**
 * This is the model class for table "risk_assesment_values".
 *
 * The followings are the available columns in table 'risk_assesment_values':
 * @property integer $id
 * @property string $name
 * @property integer $value
 */
class RiskAssesmentValues extends CActiveRecord
{
	/**
	 ...
	 * @return RiskAssesmentValues the static model class
	 */
	...
	public static function checkIfUserIsCurrentRecordViewer(){
		...
		$current_record = RiskAssesmentValues::model()->findByPk($current_record_id);
