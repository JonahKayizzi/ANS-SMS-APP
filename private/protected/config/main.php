...
return array(
	...
	'import'=>array(
		'application.models.*',
		'application.modules.TrendAnalysis.models*',
	...
	'components'=>array(
		...
		*/
		...
		'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=sms_private',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => '',
			'charset' => 'utf8',
		...
		/* 'db'=>array(
			'connectionString' => 'mysql:host=localhost;dbname=sms_temp_3',
			'emulatePrepare' => true,
			'username' => 'root',
			'password' => '',
			'charset' => 'utf8',
